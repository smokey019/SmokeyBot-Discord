...
exports.sync_7tv_emotes =
  exports.fetch7tvChannelEmotes =
  exports.fetch7tvGlobalEmotes =
    void 0;
...
function fetch7tvGlobalEmotes() {
  return __awaiter(this, void 0, void 0, function* () {
    const emotes = yield (0, utils_1.jsonFetch)(
...
function sync_7tv_emotes(message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (
      ...
      if (!emotes) {
        logger.debug(
          `Couldn't fetch 7TV Emotes for Twitch channel ${channel}.`,
        );
