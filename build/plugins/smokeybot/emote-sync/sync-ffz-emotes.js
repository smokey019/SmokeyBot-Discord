...
function cancel_sync(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (command == 'cancel-sync' &&
            ...
            yield message.reply('Your emote queue has been cancelled.  You can sync again if you wish.');
            return true;
        }
        else {
            return false;
 ...
 * @param message
 */
function sync_ffz_emotes(message, channel) {
    return __awaiter(this, void 0, void 0, function* () {
        let embed = undefined;
        ...
        if (channel &&
            ...
            logger.debug(`Fetching FFZ Emotes for Twitch channel ${channel} (requested by ${message.member.displayName} in ${message.guild.name})..`);
