...
exports.searchMonsters =
  exports.checkFavorites =
  exports.checkPokedex =
  exports.checkMonsters =
    void 0;
...
function checkMonsters(message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    logger.debug(
      `Fetching Pokémon for ${message.author.username} in ${
    ...
    if (pokemon.length > 0) {
      ...
      const current_monster = yield (0, database_1.databaseClient)(
        Monster_1.MonsterTable,
      )
        .first()
        .where('id', user.current_monster);
      pokemon.forEach((element) => {
        const monster = (0, monsters_1.findMonsterByIDLocal)(
          element.monster_id,
        );
        if (!monster) return;
        if (
        ...
        if (
          ...
          if (all_monsters[page]) {
            ...
            message_contents.push(
              `Page: **${page + 1}/${(0, utils_1.format_number)(
                all_monsters.length,
              )}**`,
            );
          }
          ...
          message_contents.push(
            `Page: **1/${(0, utils_1.format_number)(all_monsters.length)}**`,
          );
        }
      }
      ...
      const embed = new discord_js_1.MessageEmbed()
        .setAuthor(
          `${message.author.username}'s Pokémon\nShowing: ${
            (0, utils_1.format_number)(message_contents.length) +
            '/' +
            (0, utils_1.format_number)(pokemon.length)
          }`,
          (_b = message.author.avatarURL()) === null || _b === void 0
            ? void 0
            : _b.toString(),
        )
      ...
      yield message.channel
        ...
        .then(() => {
          var _a;
          logger.debug(
            `Sent Pokémon for ${message.author.tag} in ${
              (_a = message.guild) === null || _a === void 0 ? void 0 : _a.name
            }!`,
          );
        })
...
function checkPokedex(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (
      splitMsg.length > 1 &&
      !splitMsg[splitMsg.length - 1].match(/missing/i)
    ) {
      const page = parseInt(splitMsg[splitMsg.length - 1]) - 1;
      if (all_monsters[page]) {
...
function checkFavorites(message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    logger.debug(
      `Fetching Favorite Pokémon for ${message.author.tag} in ${
        (_a = message.guild) === null || _a === void 0 ? void 0 : _a.name
      }..`,
    );
    const splitMsg = message.content.replace(/ {2,}/gm, ' ').split(' ');
      ...
      const embed = new discord_js_1.MessageEmbed()
        .setAuthor(
          `${message.author.username}'s Favorites\nShowing: ${
            ...
            '/' +
            (0, utils_1.format_number)(pokemon.length)
          }\nTotal: ${(0, utils_1.format_number)(pokemon.length)}`,
          (_b = message.author.avatarURL()) === null || _b === void 0
            ? void 0
            : _b.toString(),
        )
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (pokemon.length > 0) {
      ...
      if (message_contents.length > 10) {
        ...
        const embed = new discord_js_1.MessageEmbed()
          .setAuthor(
            `${message.author.username}'s search for '${search}' - Total: ${
              (0, utils_1.format_number)(message_contents.length) +
              '/' +
              (0, utils_1.format_number)(pokemon.length)
            } - Pages: ${(0, utils_1.format_number)(all_monsters.length)}`,
            (_a = message.author.avatarURL()) === null || _a === void 0
              ? void 0
              : _a.toString(),
          )
          .setColor(0xff0000)
        ...
        yield message.channel
          ...
          .then(() => {
            var _a;
            logger.debug(
              `Sent Pokémon for ${message.author.username} in ${
