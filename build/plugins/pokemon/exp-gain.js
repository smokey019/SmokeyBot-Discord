    ...
    if (cache == undefined) {
      ...
      if (timestamp - parseInt(cache) > should_we_exp) {
        ...
        if (user.current_monster) {
          const monster = yield (0, monsters_1.getUserMonster)(
          ...
          const updateExp = yield (0, database_1.databaseClient)(
          ...
          if (updateExp) {
            ...
            if (monster.experience >= monster.level * 1250 + 1250) {
              const updateLevel = yield (0, database_1.databaseClient)(
                Monster_1.MonsterTable,
              )
                .where({ id: monster.id })
                .increment('level', 1);
              ...
              if (
                monster_dex.evos &&
                (held_item === null || held_item === void 0
                  ? void 0
                  : held_item.item_number) != 229
              ) {
                  ...
                  if (monster.level >= evolve.evoLevel) {
                    ...
                    if (updateMonster) {
                      ...
                      if (monster.shiny) {
                        ...
                        imgs = [
                          evolve.images.normal,
                          monster_dex.images.normal,
                        ];
                      }
