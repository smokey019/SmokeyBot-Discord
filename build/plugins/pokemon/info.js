...
exports.userDex =
  exports.monsterCount =
  exports.monsterDex =
  exports.currentMonsterInfo =
  exports.monsterInfo =
  exports.currentMonsterInfoBETA =
  exports.monsterInfoLatest =
  exports.monsterEmbed =
  exports.checkUniqueMonsters =
    void 0;
...
function checkUniqueMonsters(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield message.reply(
      `You have ${tempdex.length}/${monsters_1.MonsterDex.size} total unique Pokémon in your Pokédex.`,
    );
  });
}
...
function monsterEmbed(monster_db, message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    embedFields.push({
      name: '**Exp**',
      value:
        (0, utils_1.format_number)(monster_db.experience) +
        ' / ' +
...
function monsterInfoLatest(message) {
  return __awaiter(this, void 0, void 0, function* () {
    const user = yield (0, database_1.databaseClient)(
    ...
    if (user) {
      if (user[0].latest_monster) {
        const tmpMonster = yield (0, database_1.databaseClient)(
...
function monsterDex(message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (tmpSplit.length >= 3 && !tmpSplit[2].match(/shiny/i)) {
      tempMonster = (0, monsters_1.findMonsterByName)(
        tmpSplit[1].toLowerCase() + ' ' + tmpSplit[2].toLowerCase(),
      );
    } else {
      tempMonster = (0, monsters_1.findMonsterByName)(
        (_a = tmpSplit[1]) === null || _a === void 0
          ? void 0
          : _a.toLowerCase(),
      );
    }
    if (tempMonster) {
      ...
      let thumbnail = ``;
      let image = ``;
      const count = (0, utils_1.format_number)(
        yield monsterCount(tempMonster.id, message.author.id),
      );
      ...
      const evolve =
        (_c =
          (_b = tempMonster.evos) === null || _b === void 0
            ? void 0
            : _b.join(' | ')) !== null && _c !== void 0
          ? _c
          : 'None';
      const prevolve =
        (_d = tempMonster.prevo) !== null && _d !== void 0 ? _d : 'None';
      let evo_item = '';
      if (tempMonster.evos) {
