...
exports.createItemDB =
  exports.getItemDB =
  exports.msgBalance =
  exports.checkItemEvolution =
  exports.parseItems =
  exports.itemDB =
    void 0;
...
function listItems(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    exports.itemDB.forEach((element) => {
      item_message.push(
        `ID: ${element.id} - Name: ${element.name.english} - Price: ${(0,
        utils_1.format_number)(element.price)}`,
      );
    });
    let all_items = [];
...
function msgUserItems(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (items && items.length > 0) {
      let item_message = [];
      yield (0, utils_1.asyncForEach)(items, (element) =>
      ...
      yield (0, utils_1.asyncForEach)(sortable_items, (element) =>
        __awaiter(this, void 0, void 0, function* () {
...
function removeMonsterItem(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (
      ...
      const monsterDex = yield (0, monsters_1.findMonsterByID)(
        monster.monster_id,
      );
      const updateItem = yield (0, database_1.databaseClient)(
        Items_1.ItemsTable,
      )
        .where({ id: monster.held_item })
        .update({ held_by: null });
      const updateMonster = yield (0, database_1.databaseClient)(
...
function checkItemEvolution(monster, message, isTrade = false) {
  return __awaiter(this, void 0, void 0, function* () {
    const monster_dex = yield (0, monsters_1.findMonsterByID)(
      monster.monster_id,
    );
    if (
      ...
      if (
        evolve != undefined ||
        (evolve === null || evolve === void 0 ? void 0 : evolve.evoItem) ==
          item.name.english ||
        ((evolve === null || evolve === void 0 ? void 0 : evolve.evoType) ==
          'levelFriendship' &&
          itemDB.item_number == 960) ||
        ((evolve === null || evolve === void 0 ? void 0 : evolve.evoType) ==
          'trade' &&
          isTrade)
      ) {
        ...
        if (!evolve.forme) {
          updateMonster = yield (0, database_1.databaseClient)(
            Monster_1.MonsterTable,
          )
            .where({ id: monster.id })
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (user && split.length) {
      ...
      if (item_to_buy && user.currency >= item_to_buy.price) {
        ...
        if (create_item) {
          const updateUser = yield (0, database_1.databaseClient)(
            MonsterUser_1.MonsterUserTable,
          )
            .where({ uid: message.author.id })
            .decrement('currency', item_to_buy.price);
          if (updateUser) {
            message.reply(
              `You have purchased **${item_to_buy.name.english}** for **${(0,
              utils_1.format_number)(
                item_to_buy.price,
              )}**! Remaining Balance: **${(0, utils_1.format_number)(
...
function msgBalance(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (user) {
      message.reply(
        `Your current balance is **${(0, utils_1.format_number)(
          user.currency,
        )}**.`,
      );
    }
...
function createItemDB(data) {
  return __awaiter(this, void 0, void 0, function* () {
    const item = yield (0, database_1.databaseClient)(
      Items_1.ItemsTable,
    ).insert(data);
    return item;
  });
