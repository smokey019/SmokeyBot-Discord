...
exports.checkTrade =
  exports.cancelTrade =
  exports.confirmTrade =
  exports.checkEvolves =
  exports.parseTrade =
  exports.startTrade =
    void 0;
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (mentions.first()) {
      ...
      if (recipient && !check_trade) {
        const insertTrade = yield (0, database_1.databaseClient)(
          Trades_1.TradeTable,
        ).insert({
        ...
        if (insertTrade) {
          const monsterDB = yield (0, monsters_1.getUserMonster)(
            traded_monster,
          );
          const monster = yield (0, monsters_1.findMonsterByID)(
            monsterDB.monster_id,
          );
          const imgs = [];
          if (monsterDB.shiny) {
...
function checkEvolves(monster_id, message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (db_monster.length) {
      ...
      const item =
        (_a = yield (0, items_1.getItemDB)(db_monster[0].held_item)) !== null &&
        _a !== void 0
          ? _a
          : undefined;
      if (monster.evos) {
...
function cancelTrade(message) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (trades.length) {
      const trade = trades[0];
      const cancelTrade = yield (0, database_1.databaseClient)(
        Trades_1.TradeTable,
      )
        .where({ id: trade.id })
        .update({ active: 0 });
