...
exports.img_monster_ball =
  exports.getBotStats =
  exports.checkServerWeather =
  exports.voteCommand =
  exports.rollPerfectIV =
  exports.rollShiny =
  exports.rollGender =
  exports.rollLevel =
  exports.parseArgs =
...
function voteCommand(message) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    const voted =
      (_a = yield top_gg_1.dblCache.get(message.author.id)) !== null &&
      _a !== void 0
        ? _a
        : { voted: false };
    if (!voted.voted) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const embed = new discord_js_1.MessageEmbed()
      ...
      .addField(
        ...
        (0, utils_1.format_number)(queue_1.EmoteQueue.size),
        true,
      )
      .addField(
        'Total Servers',
        (0, utils_1.format_number)(discord_1.discordClient.guilds.cache.size),
        true,
      )
      .addField(
        'Total ' + (0, utils_1.theWord)(),
        (0, utils_1.format_number)(yield (0, monsters_1.getMonsterDBCount)()),
        true,
      )
      .addField(
        'Total Shiny ' + (0, utils_1.theWord)(),
        (0, utils_1.format_number)(
          yield (0, monsters_1.getShinyMonsterDBCount)(),
        ),
        true,
      )
      .addField(
        'Total ' + (0, utils_1.theWord)() + ' Users',
        (0, utils_1.format_number)(yield (0, database_1.getUserDBCount)()),
        true,
      )
      .setTimestamp();
