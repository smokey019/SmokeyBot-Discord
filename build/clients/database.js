...
exports.GuildSettingsTable =
  exports.putGuildSettings =
  exports.getUser =
  exports.getUserDBCount =
  exports.getGuildSettings =
  exports.loadGlobalSetting =
...
function loadGlobalSetting(which) {
  return __awaiter(this, void 0, void 0, function* () {
    let settings = yield cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE === null ||
    cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE === void 0
      ? void 0
      : cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE.get('main');
    if (!settings) {
      settings = yield (0, exports.databaseClient)(
        'global_smokeybot_settings',
      ).first();
      cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE === null ||
      cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE === void 0
        ? void 0
        : cache_1.SMOKEYBOT_GLOBAL_SETTINGS_CACHE.set('main', settings);
      switch (which) {
...
function getGuildSettings(message) {
  return __awaiter(this, void 0, void 0, function* () {
    const guild_settings = yield (0, exports.databaseClient)(
      exports.GuildSettingsTable,
    )
      .select()
      .where('guild_id', message.guild.id);
    if (!guild_settings[0]) {
      const insert = yield (0, exports.databaseClient)(
        exports.GuildSettingsTable,
      ).insert({
...
function getUserDBCount() {
  return __awaiter(this, void 0, void 0, function* () {
    const user_settings = yield (0, exports.databaseClient)(
