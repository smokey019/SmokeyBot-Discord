...
exports.getCache =
  ...
  exports.reportCache =
  exports.loadCache =
  exports.SMOKEYBOT_GLOBAL_SETTINGS_CACHE =
  exports.GLOBAL_COOLDOWN =
  exports.cacheToBeDeleted =
  exports.cacheTweets =
  exports.cacheTwitter =
  exports.xp_cache =
  exports.cacheClient =
  exports.caches =
    void 0;
...
function clearCache(category = defaultCache) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if (category == 'all') {
      ...
      if (exports.caches.has(category)) {
        (_a = exports.caches.get(category)) === null || _a === void 0
          ? void 0
          : _a.clear();
        return true;
      } else {
...
function getGCD(guild_id) {
  return __awaiter(this, void 0, void 0, function* () {
    const GCD = yield exports.GLOBAL_COOLDOWN === null ||
    exports.GLOBAL_COOLDOWN === void 0
      ? void 0
      : exports.GLOBAL_COOLDOWN.get(guild_id);
    const timestamp = (0, utils_1.getCurrentTime)();
    if (!GCD) {
      yield exports.GLOBAL_COOLDOWN === null ||
      exports.GLOBAL_COOLDOWN === void 0
        ? void 0
        : exports.GLOBAL_COOLDOWN.set(guild_id, timestamp - 15);
      return timestamp - 15;
    } else {
      return GCD;
    }
...
function getCache(message, settings) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let cache = yield exports.cacheClient === null ||
    exports.cacheClient === void 0
      ? void 0
      : exports.cacheClient.get(message.guild.id);
    if (!cache) {
      cache = {
        tweet: [],
        settings: {
      ...
      exports.cacheClient === null || exports.cacheClient === void 0
        ? void 0
        : exports.cacheClient.set(message.guild.id, cache);
      exports.cacheTwitter === null || exports.cacheTwitter === void 0
        ? void 0
        : exports.cacheTwitter.set(message.guild.id, 'summit1g');
      return cache;
    } else {
      return cache;
    }
