    ...
    try {
      if (!object.reply && !object.spawn) {
        object.msg.channel.send(object.outgoingMsg).then(() => {
          ...
          return logger.trace(
            `Sent a message in ${
              (_a = object.msg.guild) === null || _a === void 0
                ? void 0
                : _a.name
            }.`,
          );
        ...
        object.msg.reply(object.outgoingMsg).then(() => {
          var _a;
          return logger.trace(
            `Sent a reply to ${object.msg.author.username} in ${
              (_a = object.msg.guild) === null || _a === void 0
                ? void 0
                : _a.name
            }.`,
...
function runEmoteQueue() {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if (exports.EmoteQueue.first() && !discord_1.rateLimited) {
      ...
      const emote =
        (_b =
          (_a = object.emotes) === null || _a === void 0
            ? void 0
...
function create_emoji(emote_url, message, name) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      if (
        yield message.guild.emojis.create(emote_url, name).then((emoji) =>
